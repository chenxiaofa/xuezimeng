...
/*Table structure for table `m_exam_fillable` */
...
/*Table structure for table `m_exam_question_options` */
...
/*Table structure for table `m_exam_questions` */
...
/*Table structure for table `m_exam_session` */
...
/*Table structure for table `m_php_session` */
...
/*Table structure for table `m_wx_app` */
...
/*Table structure for table `m_wx_app_permission` */
...
/*Table structure for table `m_wx_bind` */
...
/*Table structure for table `m_wx_menu` */
...
/*Table structure for table `m_wx_users` */
...
/*Table structure for table `m_yii_log` */

CREATE TABLE `m_yii_log` (
